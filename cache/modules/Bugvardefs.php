 ...
 $GLOBALS["dictionary"]["Bug"]=array (
  ...
  array (
    ...
    array (
      ...
      'comments' => 'Free-form text used to describe how we demonstrate our implemented solution',
    ...
    array (
      'labelValue' => 'Wiki Test Specification',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'wiki_test_specification_c',
      'vname' => 'LBL_WIKI_TEST_SPECIFICATION',
      'type' => 'url',
      'massupdate' => '0',
      'default' => 'wiki',
      'no_default' => false,
      'comments' => '',
      'help' => 'Enter the link to the Test Specification in the Wiki',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      ...
      'gen' => NULL,
      'link_target' => '_blank',
      'id' => 'Bugswiki_test_specification_c',
      'custom_module' => 'Bugs',
    ),
    'dev_points_actual_c' => 
    array (
      'labelValue' => 'Points Actual',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'dev_points_actual_c',
      'vname' => 'LBL_DEV_POINTS_ACTUAL',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      'comments' => '',
      'help' => 'Non editable field, calculated from related task recording',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'precision' => '2',
      'id' => 'Bugsdev_points_actual_c',
      'custom_module' => 'Bugs',
    ),
    'dev_points_estimate_c' => 
    array (
      'labelValue' => 'Points Estimate',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'dev_points_estimate_c',
      'vname' => 'LBL_DEV_POINTS_ESTIMATE',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '0.00',
      'no_default' => false,
      'comments' => '',
      'help' => 'Enter the estimated number of Story Points to complete this Bug',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
