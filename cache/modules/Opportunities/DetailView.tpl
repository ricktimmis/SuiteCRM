...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_opp_capex_c.hidden}
...
<span class="sugar_field" id="{$fields.wfs_opp_capex_c.name}">
{sugar_number_format var=$fields.wfs_opp_capex_c.value precision=2 }
</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_opp_connex_c.hidden}
...
<span class="sugar_field" id="{$fields.wfs_opp_connex_c.name}">
{sugar_number_format var=$fields.wfs_opp_connex_c.value precision=2 }
</span>
{/if}
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_opp_filtering_c.hidden}
...
<span class="sugar_field" id="{$fields.wfs_opp_filtering_c.name}">
{sugar_number_format var=$fields.wfs_opp_filtering_c.value precision=2 }
</span>
{/if}
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_expected_revenue_c.hidden}
...
<span class="sugar_field" id="{$fields.wfs_expected_revenue_c.name}">
{sugar_number_format var=$fields.wfs_expected_revenue_c.value precision=2 }
</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_opp_mng_srvc_c.hidden}
...
<span class="sugar_field" id="{$fields.wfs_opp_mng_srvc_c.name}">
{sugar_number_format var=$fields.wfs_opp_mng_srvc_c.value precision=2 }
</span>
{/if}
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_opp_maintenance_c.hidden}
...
<span class="sugar_field" id="{$fields.wfs_opp_maintenance_c.name}">
{sugar_number_format var=$fields.wfs_opp_maintenance_c.value precision=2 }
</span>
{/if}
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_opp_opex_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_OPP_OPEX' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
<span class="sugar_field" id="{$fields.wfs_opp_opex_c.name}">
{sugar_number_format var=$fields.wfs_opp_opex_c.value precision=2 }
</span>
{/if}
</td>
{counter name="fieldsUsed"}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_contract_term_c.hidden}
...
<span class="sugar_field" id="{$fields.wfs_contract_term_c.name}">
{sugar_number_format precision=0 var=$fields.wfs_contract_term_c.value}
</span>
{/if}
</td>
{counter name="fieldsUsed"}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.reason_lost_c.hidden}
...
{if is_string($fields.reason_lost_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.reason_lost_c.name}" value="{ $fields.reason_lost_c.options }">
{ $fields.reason_lost_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.reason_lost_c.name}" value="{ $fields.reason_lost_c.value }">
{ $fields.reason_lost_c.options[$fields.reason_lost_c.value]}
{/if}
{/if}
</td>
</tr>
...
{sugar_translate label='LBL_DETAILVIEW_PANEL1' module='Opportunities'}
<script>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.wfs_opp_sage_sales_order_c.hidden}
...
<span class="sugar_field" id="{$fields.wfs_opp_sage_sales_order_c.name}">
{sugar_number_format precision=0 var=$fields.wfs_opp_sage_sales_order_c.value}
</span>
{/if}
</td>
{counter name="fieldsUsed"}
