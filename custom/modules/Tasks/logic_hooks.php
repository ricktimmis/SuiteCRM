...
// Rick T - Additional Logic Hooks -  Hook Stub File FIXME ricktimmis

$hook_array['before_save'][] = Array(10, 'BugStoryPointUpdateHook', 'custom/modules/Tasks/wfs_Tasks_LogicHook.php','BugStoryPointUpdateHook', 'TaskPointsUpdate');
