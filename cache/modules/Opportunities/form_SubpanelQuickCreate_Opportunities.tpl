...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'wfs_opp_capex_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_CAPEX' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'wfs_opp_opex_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_OPEX' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'wfs_opp_maintenance_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_MAINTENANCE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'wfs_opp_mng_srvc_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_MNG_SRVC' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'wfs_opp_connex_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_CONNEX' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'wfs_opp_filtering_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_FILTERING' module='Opportunities' for_js=true}{literal}' );
