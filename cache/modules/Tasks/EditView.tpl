...
addToValidate('EditView', 'dev_story_points_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_DEV_STORY_POINTS' module='Tasks' for_js=true}{literal}' );
