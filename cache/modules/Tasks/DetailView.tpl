...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.dev_story_points_c.hidden}
...
<span class="sugar_field" id="{$fields.dev_story_points_c.name}">
{sugar_number_format var=$fields.dev_story_points_c.value precision=2 }
</span>
{/if}
</td>
</tr>
