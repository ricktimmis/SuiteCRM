    ...
    array (
      ...
      array (
        ...
        array (
          ...
          3 => 
          array (
            'customCode' => '<input title="{$APP.LBL_GANTT_BUTTON_TITLE}" class="button" type="button" name="Gantt" id="gantt_button" value="{$APP.LBL_GANTT_BUTTON_LABEL}" onclick="javascript:window.location.href=\'index.php?module=Gantt&action=DetailView&project_id={$id}\'"/>',
          ),
        ),
      ),
      'useTabs' => false,
