 ...
 $GLOBALS["dictionary"]["Opportunity"]=array (
  ...
  array (
    ...
    array (
      ...
      'precision' => '2',
      'id' => 'Opportunitieswfs_opp_capex_c',
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'wfs_opp_opex_c',
      'vname' => 'LBL_WFS_OPP_OPEX',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '0.00',
      'no_default' => false,
      'comments' => 'Calculated field via Logic Hook',
      'help' => 'Operational Value',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'enable_range_search' => false,
      'precision' => '2',
      'id' => 'Opportunitieswfs_opp_opex_c',
      'custom_module' => 'Opportunities',
    ),
    'reason_lost_c' => 
    array (
      'labelValue' => 'Reason Lost',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'reason_lost_c',
      'vname' => 'LBL_REASON_LOST',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      'comments' => '',
      'help' => 'Select why this sale was not succesful',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'sales_reason_lost_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Opportunitiesreason_lost_c',
      'custom_module' => 'Opportunities',
    ),
    'wfs_opp_maintenance_c' => 
    array (
      'labelValue' => 'Maintenance',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'wfs_opp_maintenance_c',
      'vname' => 'LBL_WFS_OPP_MAINTENANCE',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '0.00',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => '2',
      'id' => 'Opportunitieswfs_opp_maintenance_c',
      'custom_module' => 'Opportunities',
    ),
    'wfs_contract_term_c' => 
    array (
      ...
      'vname' => 'LBL_WFS_CONTRACT_TERM',
      'type' => 'int',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      'comments' => '',
      'help' => 'Enter the contract term in months',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'Opportunitieswfs_contract_term_c',
      'custom_module' => 'Opportunities',
    ),
    ...
    array (
      ...
      'vname' => 'LBL_WFS_OPP_SAGE_SALES_ORDER',
      'type' => 'int',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      'comments' => 'Enter the Sage Sales Order Number',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      ...
      'min' => false,
      'max' => false,
      'id' => 'Opportunitieswfs_opp_sage_sales_order_c',
      'custom_module' => 'Opportunities',
    ),
    'wfs_expected_revenue_c' => 
    array (
      'labelValue' => 'Expected Revenue',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'wfs_expected_revenue_c',
      'vname' => 'LBL_WFS_EXPECTED_REVENUE',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '0.00',
      'no_default' => false,
      'comments' => 'Enter an anticipated Monthly Revenue',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      ...
      'enable_range_search' => false,
      'precision' => '2',
      'id' => 'Opportunitieswfs_expected_revenue_c',
      'custom_module' => 'Opportunities',
    ),
    'aos_quotes' => 
    array (
    ...
    'wfs_opp_mng_srvc_c' => 
    array (
      'labelValue' => 'Managed Services',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'wfs_opp_mng_srvc_c',
      'vname' => 'LBL_WFS_OPP_MNG_SRVC',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '0.00',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => '2',
      'id' => 'Opportunitieswfs_opp_mng_srvc_c',
      'custom_module' => 'Opportunities',
    ),
    'wfs_opp_connex_c' => 
    array (
      'labelValue' => 'Connectivity',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'wfs_opp_connex_c',
      'vname' => 'LBL_WFS_OPP_CONNEX',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '0.00',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => '2',
      'id' => 'Opportunitieswfs_opp_connex_c',
      'custom_module' => 'Opportunities',
    ),
    'wfs_opp_filtering_c' => 
    array (
      'labelValue' => 'Content Filtering',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'wfs_opp_filtering_c',
      'vname' => 'LBL_WFS_OPP_FILTERING',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '0.00',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => '2',
      'id' => 'Opportunitieswfs_opp_filtering_c',
      'custom_module' => 'Opportunities',
    ),
    'jjwg_maps_address_c' => 
    array (
