...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='wfs_opp_capex_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_OPP_CAPEX' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.wfs_opp_capex_c.value) <= 0}
{assign var="value" value=$fields.wfs_opp_capex_c.default_value }
{else}
{assign var="value" value=$fields.wfs_opp_capex_c.value }
{/if}  
<input type='text' name='{$fields.wfs_opp_capex_c.name}'
id='{$fields.wfs_opp_capex_c.name}'
size='30'
maxlength='18'value='{sugar_number_format var=$value precision=2 }'
title='Capital Value'
tabindex='0'
>
<td valign="top" id='wfs_opp_connex_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_OPP_CONNEX' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.wfs_opp_connex_c.value) <= 0}
{assign var="value" value=$fields.wfs_opp_connex_c.default_value }
{else}
{assign var="value" value=$fields.wfs_opp_connex_c.value }
{/if}  
<input type='text' name='{$fields.wfs_opp_connex_c.name}'
id='{$fields.wfs_opp_connex_c.name}'
size='30'
maxlength='18'value='{sugar_number_format var=$value precision=2 }'
title=''
tabindex='0'
...
<td valign="top" width='37.5%' >
<td valign="top" id='wfs_opp_filtering_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_OPP_FILTERING' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.wfs_opp_filtering_c.value) <= 0}
{assign var="value" value=$fields.wfs_opp_filtering_c.default_value }
{else}
{assign var="value" value=$fields.wfs_opp_filtering_c.value }
{/if}  
<input type='text' name='{$fields.wfs_opp_filtering_c.name}'
id='{$fields.wfs_opp_filtering_c.name}'
size='30'
maxlength='18'value='{sugar_number_format var=$value precision=2 }'
title=''
tabindex='0'
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='wfs_expected_revenue_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_EXPECTED_REVENUE' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.wfs_expected_revenue_c.value) <= 0}
{assign var="value" value=$fields.wfs_expected_revenue_c.default_value }
{else}
{assign var="value" value=$fields.wfs_expected_revenue_c.value }
{/if}  
<input type='text' name='{$fields.wfs_expected_revenue_c.name}'
id='{$fields.wfs_expected_revenue_c.name}'
size='30'
maxlength='18'value='{sugar_number_format var=$value precision=2 }'
title=''
tabindex='0'
>
<td valign="top" id='wfs_opp_mng_srvc_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_OPP_MNG_SRVC' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.wfs_opp_mng_srvc_c.value) <= 0}
{assign var="value" value=$fields.wfs_opp_mng_srvc_c.default_value }
{else}
{assign var="value" value=$fields.wfs_opp_mng_srvc_c.value }
{/if}  
<input type='text' name='{$fields.wfs_opp_mng_srvc_c.name}'
id='{$fields.wfs_opp_mng_srvc_c.name}'
size='30'
maxlength='18'value='{sugar_number_format var=$value precision=2 }'
title=''
tabindex='0'
...
<td valign="top" width='37.5%' >
<td valign="top" id='wfs_opp_maintenance_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_OPP_MAINTENANCE' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.wfs_opp_maintenance_c.value) <= 0}
{assign var="value" value=$fields.wfs_opp_maintenance_c.default_value }
{else}
{assign var="value" value=$fields.wfs_opp_maintenance_c.value }
{/if}  
<input type='text' name='{$fields.wfs_opp_maintenance_c.name}'
id='{$fields.wfs_opp_maintenance_c.name}'
size='30'
maxlength='18'value='{sugar_number_format var=$value precision=2 }'
title=''
tabindex='0'
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='wfs_contract_term_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_CONTRACT_TERM' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.wfs_contract_term_c.value) <= 0}
{assign var="value" value=$fields.wfs_contract_term_c.default_value }
{else}
{assign var="value" value=$fields.wfs_contract_term_c.value }
{/if}  
<input type='text' name='{$fields.wfs_contract_term_c.name}' 
id='{$fields.wfs_contract_term_c.name}' size='30' maxlength='2' value='{sugar_number_format precision=0 var=$value}' title='Enter the contract term in months' tabindex='0'    >
...
maxlength='100' 
value='{$value}' title=''      >
<td valign="top" id='reason_lost_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_REASON_LOST' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.reason_lost_c.name}" 
id="{$fields.reason_lost_c.name}" 
title='Select why this sale was not succesful'       
>
{if isset($fields.reason_lost_c.value) && $fields.reason_lost_c.value != ''}
{html_options options=$fields.reason_lost_c.options selected=$fields.reason_lost_c.value}
{else}
{html_options options=$fields.reason_lost_c.options selected=$fields.reason_lost_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.reason_lost_c.options }
{capture name="field_val"}{$fields.reason_lost_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.reason_lost_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.reason_lost_c.name}" 
id="{$fields.reason_lost_c.name}" 
title='Select why this sale was not succesful'          
>
{if isset($fields.reason_lost_c.value) && $fields.reason_lost_c.value != ''}
...
<input
id="{$fields.reason_lost_c.name}-input"
name="{$fields.reason_lost_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.reason_lost_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.reason_lost_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.reason_lost_c.name}-input', '{$fields.reason_lost_c.name}');sync_{$fields.reason_lost_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.reason_lost_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.reason_lost_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.reason_lost_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.reason_lost_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.reason_lost_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.reason_lost_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.reason_lost_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.reason_lost_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.reason_lost_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='wfs_opp_sage_sales_order_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_WFS_OPP_SAGE_SALES_ORDER' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.wfs_opp_sage_sales_order_c.value) <= 0}
{assign var="value" value=$fields.wfs_opp_sage_sales_order_c.default_value }
{else}
{assign var="value" value=$fields.wfs_opp_sage_sales_order_c.value }
{/if}  
<input type='text' name='{$fields.wfs_opp_sage_sales_order_c.name}' 
id='{$fields.wfs_opp_sage_sales_order_c.name}' size='30' maxlength='10' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
<td valign="top" id='_label' width='12.5%' scope="col">
&nbsp;
</td>
{counter name="fieldsUsed"}
...
addToValidate('EditView', 'wfs_opp_capex_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_CAPEX' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'wfs_opp_opex_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_OPEX' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'reason_lost_c', 'enum', false,'{/literal}{sugar_translate label='LBL_REASON_LOST' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'wfs_opp_maintenance_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_MAINTENANCE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'wfs_contract_term_c', 'int', false,'{/literal}{sugar_translate label='LBL_WFS_CONTRACT_TERM' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'wfs_opp_sage_sales_order_c', 'int', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_SAGE_SALES_ORDER' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'wfs_expected_revenue_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_EXPECTED_REVENUE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'wfs_opp_mng_srvc_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_MNG_SRVC' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'wfs_opp_connex_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_CONNEX' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'wfs_opp_filtering_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_WFS_OPP_FILTERING' module='Opportunities' for_js=true}{literal}' );
