...
-- Table structure for table `aos_products_cstm`
 ...
 CREATE TABLE `aos_products_cstm` (
   ...
   `discount_c` tinyint(1) DEFAULT '0',
   PRIMARY KEY (`id_c`)
...
-- Table structure for table `aos_quotes_cstm`
 ...
 DROP TABLE IF EXISTS `aos_quotes_cstm`;
 /*!40101 SET @saved_cs_client     = @@character_set_client */;
 /*!40101 SET character_set_client = utf8 */;
 CREATE TABLE `aos_quotes_cstm` (
   `id_c` char(36) NOT NULL,
   `quote_type_c` varchar(100) DEFAULT 'Standard',
   PRIMARY KEY (`id_c`)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
 /*!40101 SET character_set_client = @saved_cs_client */;
...
-- Table structure for table `bugs_cstm`
 ...
 CREATE TABLE `bugs_cstm` (
   `id_c` char(36) NOT NULL,
   `dev_points_estimate_c` decimal(6,2) DEFAULT '0.00',
   `dev_points_actual_c` decimal(6,2) DEFAULT NULL,
   `wiki_test_specification_c` varchar(255) DEFAULT 'wiki',
   PRIMARY KEY (`id_c`)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
 /*!40101 SET character_set_client = @saved_cs_client */;
...
-- Table structure for table `tasks_cstm`
 ...
 CREATE TABLE `tasks_cstm` (
   `id_c` char(36) NOT NULL,
   `dev_story_points_c` decimal(4,2) DEFAULT '0.00',
   PRIMARY KEY (`id_c`)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
 /*!40101 SET character_set_client = @saved_cs_client */;
 
-- Dump completed on 2014-10-28 12:59:55
...
-- Dump completed on 2014-10-28 13:19:26
